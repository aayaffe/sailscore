...
import com.avimarineinnovations.sailscore.ListAdapters.AlternateRowCursorAdapter;
...
public class EntriesListActivity extends ListActivity {
  ...
  private void fillData() {
    ...
    String[] from = new String[]{SailscoreDbAdapter.KEY_HELM, SailscoreDbAdapter.KEY_CREW,
        SailscoreDbAdapter.KEY_CLASS, SailscoreDbAdapter.KEY_SAILNO, SailscoreDbAdapter.KEY_CLUB};
    int[] to = new int[]{R.id.helm, R.id.crew, R.id.boatclass, R.id.sailno, R.id.club};
    AlternateRowCursorAdapter entries = new AlternateRowCursorAdapter(this, R.layout.entry_row,
  ...
  public boolean onMenuItemSelected(int featureId, MenuItem item) {
    switch (item.getItemId()) {
      case R.id.menu_insert:
        createEntry();
        return true;
      case R.id.menu_import_from_orc:
        importEntryFromORC();
        return true;
    }
  ...
  private void importEntryFromORC() {
    Intent i = new Intent(this, OrcImportActivity.class);
    startActivityForResult(i, ENTRY_CREATE);
  }
